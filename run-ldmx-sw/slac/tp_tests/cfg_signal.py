...
lheFile='/nfs/slac/g/ldmx/data/mc/signal_lhe/4gev/onShell_pMax2_v4_longseed/LDMX_W_UndecayedAP.4.0GeV.W.pMax.2.0.mA.1.0.2200_unweighted_events.lhe'

sim.generators.append(generators.lhe( "Signal Generator", lheFile )) 
...
p.outputFiles=["simoutput_signal.root"]
p.maxEvents = 20*1000 #0

# can grep to find a line like this
# "#  Number of Events        :       20753"
