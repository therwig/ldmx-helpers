...
for proc in "pro_0p1_4GeV" "ele_0p1_4GeV"
do
...
time ldmx fire cfg/cfg_pfReco.py --step pf --input $d/gen/gen.$proc$sfx.root --output $d/pf/pf.$proc$sfx$clusTag.root #-n 1000
